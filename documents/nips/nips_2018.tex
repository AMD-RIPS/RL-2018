...
were trained.\todo{add more motivation here} 
...
tracks\todo{add curriculum learning discussion}. This result
...
was selected for analysis.\todo{need stopping criterion?} 
...
% nick: this sentence doesnt really make sense, I also don't like 'informed'
%Even with about the
%environment, the agent is capable of making informed decisions.
