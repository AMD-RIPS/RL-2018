...
%years, ranging from solving classical video games to beating world
  %class Go players.
Successful RL models are typically trained for
narrow, well-defined tasks using a vast amount of computation. They
perform well in their defined task, but changes in the
...
methods could improve the generalization capacity of deep RL
...
experiences, and are not likely to transfer to other tasks effectively.
